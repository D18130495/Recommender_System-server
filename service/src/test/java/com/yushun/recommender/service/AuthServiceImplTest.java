...
public class AuthServiceImplTest {
    ...
    public void userSystemRegister_validInformation_success() {
        redisTemplate.opsForValue().set("d18130495@mytudublin.com", "123456");
    ...
    @Test(timeout = 30000)
    @Transactional
    public void tokenLoginRefresh_googleValidToken_success() {
        ...
        Result result = userService.tokenLoginRefresh(newToken);
    ...
    @Test(timeout = 30000)
    @Transactional
    public void tokenLoginRefresh_systemValidToken_success() {
    ...
    @Test(timeout = 30000)
    @Transactional
    public void tokenLoginRefresh_userNotFound_fail() {
